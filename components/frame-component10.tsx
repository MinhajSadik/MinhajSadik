...
`;
const LogoImageIcon = styled(Image)`
  height: 27.2px;
  width: 30.9px;
  position: relative;
  object-fit: contain;
...
const RightSide = styled.div`
  ...
  max-width: 100%;
`;
const MenuRightChild = styled(Image)`
  height: 26.9px;
  width: 34.9px;
  margin: 0 !important;
  position: absolute;
...
const MenuRight = styled.div`
  ...
  z-index: 1;
`;
const MenuItems1 = styled.header`
  flex: 1;
  display: flex;
  flex-direction: row;
  align-items: flex-start;
  ...
  font-family: var(--font-inter);
`;
const MenuItemsWrapperRoot = styled.div`
  align-self: stretch;
  display: flex;
  flex-direction: row;
  align-items: flex-start;
...
const FrameComponent10: NextPage<FrameComponent10Type> = ({
  ...
  return (
    <MenuItemsWrapperRoot className={className}>
      <MenuItems1>
        <MenuDivider />
        <MenuRight>
          <LeftSide>
