...
import CheckmarkContainers from "./checkmark-containers";
...
`;
const CourseDetailsRoot = styled.div`
  width: 1237px;
  height: 884px;
...
const CourseDetails: NextPage<CourseDetailsType> = ({ className = "" }) => {
  return (
    <CourseDetailsRoot className={className}>
      <PageHeading>
        <PageHeadingChild
          width={730}
          height={368}
